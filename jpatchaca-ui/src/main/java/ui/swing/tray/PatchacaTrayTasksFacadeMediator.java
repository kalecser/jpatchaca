...
public class PatchacaTrayTasksFacadeMediator implements Startable{
	...
	public PatchacaTrayTasksFacadeMediator(final PatchacaTray tray,  final TasksSystem tasksSystem, final SwingTasksUser tasksUser){
		this.tray = tray;
		...
		this.tray.stopTaskAlert().subscribe(new Subscriber() {
			public void fire() {
				PatchacaTrayTasksFacadeMediator.this.tasksSystem.stopTask(tasksUser.getSelectedTask());			
			}			
		});
